...
export interface TimelineEntry {
  ...
  detail: string;
  kidDetail: string;
  kidHighlight?: boolean; // Show in kid mode "greatest hits"
  kidEmoji?: string; // Big emoji for kid card
  kidTitle?: string; // Fun kid-friendly title
}

export const timelineEntries: TimelineEntry[] = [
  { year: 1817, title: "Promenades Aériennes", detail: "The first wheeled roller coaster opens in Paris — riders descended a gentle slope on carts locked to a wooden track. The ride used gravity alone and reached roughly 30 mph.", kidDetail: "The very first roller coaster EVER! It was made of wood and went about as fast as a car in a parking lot. People in fancy clothes rode it for fun!", kidHighlight: true, kidEmoji: "🎢", kidTitle: "The Very First Coaster!" },
  ...
  { year: 1895, title: "Flip Flap Railway", detail: "The first looping roller coaster. A perfectly circular loop produced up to 12 G of centripetal force — enough to cause neck injuries. Replaced quickly by the safer clothoid loop design.", kidDetail: "The first upside-down roller coaster! But OOPS — engineers made the loop a perfect circle, and it hurt people's necks! They had to learn to make egg-shaped loops instead.", kidHighlight: true, kidEmoji: "🔄", kidTitle: "First Loop... OUCH!" },
  ...
  { year: 1959, title: "Matterhorn Bobsleds — Disneyland", detail: "The world's first tubular steel-track roller coaster. Arrow Development's innovation of bending steel tubes allowed smoother, more complex track shapes — the foundation of modern coasters.", kidDetail: "Walt Disney wanted a mountain at Disneyland with a coaster inside! Engineers invented smooth steel tubes to make it work. This invention changed coasters FOREVER — almost every coaster today uses this idea!", kidHighlight: true, kidEmoji: "🏰", kidTitle: "Disney Changed Everything!" },
  ...
  { year: 1989, title: "Magnum XL-200 — Cedar Point", detail: "Arrow Dynamics shatters the 200-foot barrier. At 205 ft tall and 72 mph, it inaugurates the 'hypercoaster' era. Its out-of-seat airtime redefined what coasters could deliver.", kidDetail: "The first coaster over 200 feet tall — that's taller than a 20-story building! Everyone thought it was IMPOSSIBLE to build something this big. It made you feel like you were flying out of your seat!", kidHighlight: true, kidEmoji: "🚀", kidTitle: "The Impossible Giant!" },
  ...
  { year: 2005, title: "Kingda Ka — Six Flags Great Adventure", detail: "At 456 feet and 128 mph, Kingda Ka takes the height and speed records from Dragster. Uses a hydraulic launch generating 1.67 G of acceleration.", kidDetail: "The TALLEST roller coaster in the whole world! At 456 feet, it's taller than the Statue of Liberty! You launch from 0 to 128 mph in just 3 seconds, then go straight UP into the sky!", kidHighlight: true, kidEmoji: "👑", kidTitle: "The Tallest Ever!" },
  { year: 2010, title: "Formula Rossa — Ferrari World", detail: "A hydraulic-launched Intamin coaster reaching 149.1 mph — the fastest in the world. Riders wear goggles to protect from sand and insects at those speeds.", kidDetail: "The FASTEST roller coaster on Earth! It goes 149 mph — faster than a cheetah can run, faster than most race cars can drive! It's so fast you have to wear GOGGLES so bugs don't hit your eyes!", kidHighlight: true, kidEmoji: "🏎️", kidTitle: "The Fastest Ever!" },
  ...
  { year: 2021, title: "Velocicoaster — Universal Orlando", detail: "Intamin's multi-launch masterpiece features a 155-foot top hat, zero-G stall, mosasaurus roll, and two LSM launches. Themed to Jurassic World with near-miss dinosaur encounters.", kidDetail: "A roller coaster where DINOSAURS chase you! You launch past real-looking velociraptors, go upside-down FOUR times, and feel like you're escaping from Jurassic World!", kidHighlight: true, kidEmoji: "🦖", kidTitle: "Dinosaur Escape!" },
  ...
  { year: 2026, title: "The Future", detail: "Active developments include magnetic launch systems exceeding 150 mph, VR-enhanced rides, adaptive track systems, and AI-designed track profiles optimized for airtime and smoothness.", kidDetail: "What comes next? Coasters that go even FASTER! Rides where you wear VR goggles and fly through space! Maybe even coasters that change their track every time you ride! What would YOUR dream coaster be?", kidHighlight: true, kidEmoji: "🔮", kidTitle: "What's Next?" },
];
...
export const triviaQuestions: TriviaQuestion[] = [
  ...
  { question: "What does RMC stand for in roller coaster manufacturing?", options: ["Ride Manufacturing Corp", "Rocky Mountain Construction", "Roller Motor Company", "Rail & Metal Coasters"], answer: 1, funFact: "Rocky Mountain Construction, founded by Fred Grubb, revolutionized the industry by converting rough wooden coasters into smooth hybrid steel-on-wood thrill machines.", kidQuestion: "What does RMC stand for? They make AWESOME coasters!", kidOptions: ["Ride Making Company", "Rocky Mountain Construction 🏔️", "Roller Motor Cars", "Really Mean Coasters"], kidFunFact: "Rocky Mountain Construction takes old bumpy wooden coasters and makes them SUPER smooth and fun! 🏔️" },
  ...
  { question: "What year did the first tubular steel roller coaster open?", options: ["1955", "1959", "1963", "1972"], answer: 1, funFact: "The Matterhorn Bobsleds at Disneyland in 1959 used Arrow Development's tubular steel track — the technology behind every modern coaster.", kidQuestion: "Where was the FIRST modern roller coaster built?", kidOptions: ["Six Flags", "Disneyland 🏰", "Universal Studios", "Cedar Point"], kidFunFact: "Disneyland built the first modern coaster inside a fake mountain! 🏔️🏰" },
  ...
  { question: "Which coaster has the most inversions?", options: ["Smiler (14)", "Colossus (10)", "Banshee (7)", "Montu (7)"], answer: 0, funFact: "The Smiler at Alton Towers holds the record with 14 inversions — riders go upside-down 14 times in a single ride!", kidQuestion: "Which coaster flips you upside-down the MOST times?", kidOptions: ["The Smiler - 14 times! 🔄", "Colossus - 10 times", "Banshee - 7 times", "Montu - 7 times"], kidFunFact: "The Smiler flips you upside-down 14 TIMES! Can you spin around 14 times? 🤪" },
  ...
  { question: "What is the longest roller coaster in the world?", options: ["Steel Dragon 2000", "The Beast", "Fury 325", "Millennium Force"], answer: 0, funFact: "Steel Dragon 2000 at Nagashima Spa Land, Japan stretches 8,133 feet (1.54 miles) — you're on the track for over 4 minutes!", kidQuestion: "Which coaster is the LONGEST ride?", kidOptions: ["Steel Dragon 2000 🐉", "The Beast", "Fury 325", "Millennium Force"], kidFunFact: "Steel Dragon 2000 is so long the ride takes over 4 MINUTES! That's longer than most TV commercials! 🐉" },
  ...
  { question: "What is the term for a coaster that exceeds 300 feet tall?", options: ["Mega coaster", "Hyper coaster", "Giga coaster", "Strata coaster"], answer: 2, funFact: "Coaster classifications: Hyper (200+ ft), Giga (300+ ft), Strata (400+ ft). Millennium Force (2000) was the first giga coaster.", kidQuestion: "What do we call SUPER TALL coasters over 300 feet?", kidOptions: ["Mega coaster", "Hyper coaster", "Giga coaster 🦕", "Strata coaster"], kidFunFact: "Giga means GIANT! These coasters are as tall as 30 houses stacked up! 🏠🏠🏠" },
  ...
  { question: "Which theme park has the most roller coasters?", options: ["Cedar Point", "Six Flags Magic Mountain", "Europa-Park", "Walt Disney World"], answer: 1, funFact: "Six Flags Magic Mountain holds the record with 20 roller coasters, narrowly beating Cedar Point's 17.", kidQuestion: "Which park has the MOST roller coasters?", kidOptions: ["Cedar Point", "Six Flags Magic Mountain 🏆", "Europa-Park", "Disney World"], kidFunFact: "Six Flags Magic Mountain has 20 coasters! You'd need 20 DAYS to ride them all once a day! 🎢🎢🎢" },
  ...
  { question: "What is the steepest drop angle on any coaster?", options: ["90°", "95°", "97°", "Beyond vertical — some exceed 100°"], answer: 3, funFact: "Several coasters feature beyond-vertical drops (past 90°). TMNT Shellraiser has a 121.5° drop — you actually lean forward past straight down!", kidQuestion: "Can roller coasters drop you MORE than straight down?", kidOptions: ["No way!", "Yes - past straight down! 🤯", "Only a little", "That's impossible"], kidFunFact: "Some coasters tilt you PAST straight down! You lean forward into the drop! AHHHH! 🤯" },
  ...
  { question: "What is the world's oldest operating roller coaster?", options: ["Cyclone (1927)", "Leap-the-Dips (1902)", "Jack Rabbit (1920)", "Giant Dipper (1924)"], answer: 1, funFact: "Leap-the-Dips at Lakemont Park, Pennsylvania opened in 1902 and is a National Historic Landmark. It's a side-friction figure-eight design that reaches just 10 mph.", kidQuestion: "How OLD is the oldest roller coaster you can still ride?", kidOptions: ["50 years old", "Over 120 years old! 👴", "80 years old", "25 years old"], kidFunFact: "Leap-the-Dips is over 120 years old! Your great-great-great grandparents could have ridden it! 👴" },
